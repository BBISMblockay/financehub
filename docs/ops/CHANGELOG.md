...
| 2026-06 | Shopify ingestion | Phase 1 schema: `shopify_connections`, `shopify_location_mappings`, `sync_jobs`, company integration flags — see `docs/ops/shopify-ingestion.md` |
