...
test('actual onboarding UI fetches an explicitly scoped report, reviews stored balances and never invokes QBO posting',async()=>{
 ...
 vm.runInNewContext(code,{window,document:{getElementById:el,querySelectorAll:()=>[]},location:{pathname:'/v2/accounting-books.html'},console});await settle();
