...
test('each suite page pins its shared design assets to the shipped content',async()=>{
 ...
 for(const page of ['transactions','accounting-books','qbo-reports','cash-forecast','schedules','fixed-assets','accounting-export','customers']){
  ...
  const assets=['accounting-suite.css',...(page==='cash-forecast'?['cashflow-model.js','cashflow.js','cashflow.css','cashflow-charts.js']:[]),...(page==='transactions'?['plaid-bank-feed.js']:[]),...(page==='accounting-books'?['accounting-books.css','accounting-books.js','accounting-ledger.js','qbo-history.js','migration-status.js']:[]),...(page==='customers'?['customers.css']:[])];
