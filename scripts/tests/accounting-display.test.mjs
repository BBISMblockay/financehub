...
test('each suite page pins its shared design assets to the shipped content',async()=>{
 ...
 for(const page of ['transactions','accounting-books','qbo-reports','cash-forecast','schedules','fixed-assets','accounting-export']){
  ...
  const assets=['accounting-suite.css',...(page==='cash-forecast'?['cashflow-model.js','cashflow.js','cashflow.css','cashflow-charts.js']:[]),...(page==='accounting-books'?['accounting-books.css','accounting-books.js','qbo-history.js','migration-status.js']:[])];
