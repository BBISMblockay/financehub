...
(async () => {
  ...
  try {
    ...
    const tables = {
      marketing_kpis_daily: [], v_marketing_mer_daily: [], instagram_media_insights: [], facebook_page_insights_daily: [],
    ...
    R.ok('creative has Link control', await page.locator('[data-link-ad="ad-1"]').count() === 1);
    await page.click('[data-link-ad="ad-1"]');
    ...
    R.has(await launch.locator('#lc2-summary').innerText(), 'Linked Meta creatives (1)');
    ...
    await focused.click('[data-link-ad="ad-1"]');
