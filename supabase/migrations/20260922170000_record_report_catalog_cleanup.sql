...
update public.silo_chat_saved_reports set title = 'Inventory Summary' where id = 'c1000000-0000-4000-a000-000000000001' and source = 'system' and company_entity_id is null;
...
update public.silo_chat_saved_reports set title = 'Overstock' where id = 'c1000000-0000-4000-a000-000000000007' and source = 'system' and company_entity_id is null;
...
update public.silo_chat_saved_reports set title = 'Attribution vs Sales' where id = 'c3000000-0000-4000-a000-000000000005' and source = 'system' and company_entity_id is null;
...
-- Inventory Summary, Overstock and Attribution vs Sales re-assert their TITLE
-- only: 20260925150000 rewrote their queries and owns their descriptions, and
-- this file replays after it in apply_all_post_merge.sql.
