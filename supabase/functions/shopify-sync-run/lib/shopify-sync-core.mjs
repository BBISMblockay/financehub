 ...
 * Mirrors scripts/lib/shopify-sync-core.mjs (kept in sync by hand, same as
...
export async function runInventorySnapshot(supabase, connection, { batchId } = {}) {
  ...
  for (const loc of locations) {
    ...
    for (const lvl of levels) {
      ...
      const rowHash = await hashRow([connection.company_entity_id, locId, sku, productId || '', snapshotAt]);
